...
enum I2C_master_status_messages{
	I2C_S_cond_ack = 0x08,					// Master mode:: start condition acknowledged
	I2C_RS_cond_ack = 0x10,					// Master mode:: repeated start condition acknowledged
	I2C_SLA_W_ack = 0x18,					// Master mode:: SLA+W recived followed by acknowledged
	I2C_SLA_R_ack = 0x40,					// Master mode:: SLA+R recived followed by acknowledged
	...
	I2C_SLA_W_nack = 0x20,					// Master mode:: SLA+W recived followed by not acknowledged
	I2C_SLA_R_nack = 0x48,					// Master mode:: SLA+R recived followed by not acknowledged
